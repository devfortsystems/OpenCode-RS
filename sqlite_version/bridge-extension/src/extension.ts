                    ...
                    try {
                        ...
                        if (lmModels && lmModels.length > 0) {
                            for (const m of lmModels) {
                                ...
                                if (vendor.includes('codeium') || vendor.includes('windsurf')) provider = 'windsurf';
                                else if (vendor.includes('cursor')) provider = 'cursor';
                                else if (vendor.includes('trae') || vendor.includes('bytedance')) provider = 'trae';
                                else if (vendor.includes('copilot') || vendor.includes('github')) provider = 'copilot';
                                else if (vendor.includes('google') || vendor.includes('antigravity') || id.includes('gemini')) provider = 'antigravity';
                                else if (vendor.includes('anthropic') || id.includes('claude')) provider = 'anthropic';
                                else if (vendor.includes('openai') || id.includes('gpt')) provider = 'openai';
                                else if (vendor.includes('amazon')) provider = 'amazon-q';
                                else if (vendor.includes('augment')) provider = 'augment';
